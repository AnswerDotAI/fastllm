...
# %% auto #0
__all__ = ['Delta', 'normalize_openai_response_event', 'PartAccum', 'openai_chat_index_fn', 'normalize_openai_chat_delta',
           'normalize_anthropic_event', 'anthropic_index_fn', 'normalize_gemini_event', 'gemini_index_fn',
           'acollect_stream']
...
# %% ../nbs/02_streaming.ipynb #f9460d67
