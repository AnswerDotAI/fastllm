...
# %% auto #0
__all__ = ['tool_info', 'usage_info', 'think_start', 'think_end', 're_think', 'effort', 'MediaUrl', 'remove_cache_ckpts',
           'contents', 'stop_reason', 'mk_msg', 'parse_tools', 'strip_tools', 'conv_tools', 'FenceToolStop',
           'extract_fence_call', 'fmt2hist', 'mk_msgs', 'cite_footnote', 'postproc', 'lite_mk_func', 'ToolResponse',
