...
# %% auto #0
__all__ = ['api_ns', 'norm_tool_calls', 'norm_finish', 'norm_parts', 'raw_msg', 'norm_sse_event', 'delta_index_fn', 'collate_raw',
...
# %% ../nbs/03_oai_chat.ipynb #a30e4324
def raw_msg(resp):
...
# %% ../nbs/03_oai_chat.ipynb #b7a19b8d
