...
# %% auto #0
__all__ = ['model_prices_url', 'model_prices_meta', 'get_model_meta', 'openai_chat_cost', 'openai_responses_cost',
           'anthropic_cost', 'gemini_cost']
...
def cost(self:Completion):
    meta = dict2obj(get_model_meta(self.model, self.vendor_name))
