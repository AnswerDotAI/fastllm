...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_oapi.ipynb.

# %% auto #0
__all__ = ['sanitized_params', 'mk_sig', 'mk_doc', 'OpFunc', 'OpGroup', 'OpenAPIClient']

# %% ../nbs/05_oapi.ipynb #632a2010
import json
