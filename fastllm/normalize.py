...
# %% auto #0
__all__ = ['ant_tc_types', 'ApiName', 'FinishReason', 'finish_reps_map', 'ToolCall', 'anthropic_tool_call',
           ...
           'usage_from_gemini', 'Completion', 'canon_finish', 'openai_responses_parts', 'normalize_openai_response',
           'normalize_openai_chat_completion', 'normalize_anthropic_message', 'normalize_gemini_generate']
