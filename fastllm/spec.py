...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_spec.ipynb.
...
# %% ../nbs/04_spec.ipynb #f64bdb34
def _op_docs_url(op):
    desc = op.get("description")
    if desc and (durl := _first_url(desc)): return durl

# %% ../nbs/04_spec.ipynb #112ac323
