...
# %% auto #0
__all__ = ['specs_path', 'ant_spec', 'oai_spec', 'gem_spec', 'vendor_mapping', 'denorm_openai_responses_tool_use',
           'mk_tool_res_msg', 'denorm_openai_responses_tool_result', 'denorm_openai_responses_assistant',
           'denorm_openai_responses_tool', 'denorm_openai_responses_msgs', 'denorm_openai_chat_tool_use',
           'denorm_openai_chat_tool_result', 'denorm_openai_chat_user', 'denorm_openai_chat_assistant',
           'denorm_openai_chat_tool', 'denorm_openai_chat_msgs', 'denorm_anthropic_tool_use',
           'denorm_anthropic_tool_result', 'denorm_anthropic_user', 'denorm_anthropic_assistant',
           'denorm_anthropic_tool', 'denorm_anthropic_msgs', 'denorm_gemini_tool_use', 'denorm_gemini_tool_result',
           'denorm_gemini_user', 'denorm_gemini_assistant', 'denorm_gemini_tool', 'denorm_gemini_msgs',
           'denorm_openai_responses_tools', 'denorm_openai_chat_tools', 'denorm_anthropic_tools', 'denorm_gemini_tools',
           ...
           'denorm_openai_responses_user', 'infer_api_name', 'mk_client', 'ContextWindowExceededError', 'acomplete']
...
# %% ../nbs/03_acomplete.ipynb #dd19f8de
...
async def acomplete(msgs, model, stream=False, system=None, max_tokens=None, temperature=None, tools=None, tool_choice=None, reasoning_effort=None, web_search_options=None, **kwargs):
