...
# %% auto #0
__all__ = ['specs_path', 'ant_spec', 'oai_spec', 'gem_spec', 'vendor_mapping', 'api2spec', 'defaults', 'resolve_api_vendor',
...
def resolve_api_vendor(model=None, vendor_name=None, api_name=None, api_key=None, base_url=None):
    ...
    raise ValueError(f"Model {model} can't be auto resolved, {err_msg}")

# %% ../nbs/06_acomplete.ipynb #2fd2bdeb
@flexicache()
