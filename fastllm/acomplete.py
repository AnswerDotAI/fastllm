...
# %% auto #0
__all__ = ['repo_path', 'specs_path', 'ant_spec', 'oai_spec', 'gem_spec', 'vendor_mapping', 'denorm_openai_responses_tool_use',
           ...
           'denorm_anthropic_reasoning', 'denorm_gemini_reasoning', 'denorm_openai_responses_user', 'infer_api_name',
           'mk_client', 'acomplete']
